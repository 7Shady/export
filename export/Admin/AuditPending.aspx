<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AuditPending.aspx.cs" Inherits="export.Admin.AuditPending" %> <asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"> </asp:Content> <asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">     
         <!-- page content -->
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">                  
                  <div class="x_content"> 
                       <div class="x_title">
                    <h2>Audit & structuring   <small>Pending Assignments</small></h2>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="export.Admin.test" %>
...
<body class="nav-md">
    ...
    <div class="main_container">
              ...
              <div class="menu_section">
               ...
               <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> Buyer Financial Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <li><a href="buyer_pending.html">Pending Assignments</a></li>
                      <li><a href="buyer_completed.html">Completed Assignments</a></li>
                      <li><a href="buyer_declined.html">Declined Assignments</a></li>
                    </ul>
                  </li>
				   <li><a><i class="fa fa-table"></i> Credit Insurance Cover <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="credit_insurance_pending.html">Pending Assignments</a></li>
                      <li><a href="credit_insurance_completed.html">Completed Assignments</a></li>
                      <li><a href="credit_insurance_declined.html">Declined Assignments</a></li>
                    </ul>
                  </li>
				   <li><a><i class="fa fa-table"></i> Debt Collection <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                     <li><a href="debt_collection_pending.html">Pending Assignments</a></li>
                      <li><a href="debt_collection_completed.html">Completed Assignments</a></li>
                      <li><a href="debt_collection_declined.html">Declined Assignments</a></li>
                    </ul>
                  </li>
				   <li><a><i class="fa fa-table"></i> Audit & structuring <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="audit_structuring_pending.html">Pending Assignments</a></li>
                      <li><a href="audit_structuring_completed.html">Completed Assignments</a></li>
                      <li><a href="audit_structuring_declined.html">Declined Assignments</a></li>
                    </ul>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/user.png" alt="">Satish Kumar
		...
		<div class="row">
		<div class="col-sm-12">
		<h2 style="    text-align: center; margin-top: 20%; font-size: 50px;">Coming Soon</h2>
		</div>	
		</div>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admino.Master" AutoEventWireup="true" CodeBehind="BuyerView.aspx.cs" Inherits="export.Admin.BuyerView" %>
                        ...
                        <table class="table-bordered table-hover table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="LabelBuyerId" runat="server"></asp:Label>
                                    </td>

<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="AuditView.aspx.cs" Inherits="export.Admin.AuditView" %>
    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2><asp:Label ID="LabelNamee" runat="server" ></asp:Label> <small> </small></h2>
...
<th><asp:Label ID="LabelClientId" runat="server" ></asp:Label>
</th>

<th class="bg-green-light">Client Name:</th>
<th><asp:Label ID="LabelCName" runat="server" ></asp:Label>
</th>

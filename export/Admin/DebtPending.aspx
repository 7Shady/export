<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admino.Master" AutoEventWireup="true" CodeBehind="DebtPending.aspx.cs" Inherits="export.Admin.DebtPending" %>
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Debt Collection  <small>Pending Assignments</small></h2>
            ...
            <asp:GridView ID="GridViewDCP" CellSpacing="0" CellPadding="4" runat="server" Width="100%" OnSelectedIndexChanged="GridViewDCP_SelectedIndexChanged"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="ClientId" HeaderText="Client ID" SortExpression="DebtId" ItemStyle-Width="20%" />

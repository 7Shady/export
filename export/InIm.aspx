...
<body>
    ...
    <div class="page" id="top">
        ...
        <section class="home-section parallax-2 bg-scroll" data-background="images/full-width-images/glocal_thinkers_top.jpg" id="home">
                    ...
                    <div class="home-text">
                        <div class="relative">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="col-md-12 col-sm-12 col-xs-12" style="color: #fff; font-size: 32px; padding-right:28px;">
                                                Global platform of opportunities<br />
                                                and solutions
                                    </div>

                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <span style="padding-top:8px">
                                            <input type="submit" name="btnExpert" value="Talk to an Expert" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;btnExpert&quot;, &quot;&quot;, false, &quot;&quot;, &quot;clientzone.aspx#expert&quot;, false, false))" id="btnExpert" class="btn btn-mod btn-blue btn-medium btn-round btntop4" style="width:200px; margin-top:10px; font-size:1em; font-family: Lato,sans-serif; border-radius: 5px; padding:10px;" />
                                            </span> 
                                        <span style="margin-top:10px">
                                            <input type="submit" name="btn_2" value="Become a Consultant" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;btn_2&quot;, &quot;&quot;, false, &quot;&quot;, &quot;becomeconsultant.aspx&quot;, false, false))" id="btn_2" class="btn btn-mod btn-green btn-medium btn-round" style="width:200px; margin-top:10px; font-size:1em; font-family: Lato,sans-serif; border-radius: 5px; padding:10px;" />
                                            </span>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12" style="padding-top:1px;">
                                        <span style="margin-top:10px">
                                            <input type="submit" name="btn_3" value="Post a Project" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;btn_3&quot;, &quot;&quot;, false, &quot;&quot;, &quot;clientzone.aspx&quot;, false, false))" id="btn_3" class="btn btn-mod btn-yellow btn-medium btn-round" style="width:200px; margin-top:10px; font-size:1em; font-family: Lato,sans-serif; border-radius: 5px; padding:10px;" />
                                           
                                            </span> 
                                        <span style="padding-top:8px">
                                            <input type="submit" name="btn_4" value="Post a Query" onclick="javascript:WebForm_DoPostBackWithOptions(new WebForm_PostBackOptions(&quot;btn_4&quot;, &quot;&quot;, false, &quot;&quot;, &quot;clientzone.aspx#postquery&quot;, false, false))" id="btn_4" class="btn btn-mod btn-red btn-medium btn-round" style="width:200px; margin-top:10px; font-size:1em; font-family: Lato,sans-serif; border-radius: 5px; padding:10px;" />
	...
	<div id="DIV_2">
		...
		<div id="DIV_3">
			 <a href="Default.aspx" id="A_4"><img src="images/logo-dark.png" alt="" id="IMG_5" /></a>
		</div>
		<div id="DIV_6">
			<i id="I_7"></i>
		</div>
